                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <a class="btn btn-primary" href="/fornecedor/novo"> <i class="nav-icon fas fa-plus"></i></a>
                        </div><br>
                        <!-- /.card-header -->
                                ...
                                <tbody>
                                    <?php if (!empty($fornecedor)) : ?>
                                        <?php foreach ($fornecedor as $data) : ?>
                                            <tr>
                                                <td><?php echo $data['id_fornecedor'] ?></td>
                                                ...
                                                <td>
                                                    <a href="/fornecedor/visualizar/<?php echo $data['id_fornecedor'] ?>" class="btn btn-primary btn-xs"><i class="fas fa-search"></i></a>
                                                    <a href="/fornecedor/editar/<?php echo $data['id_fornecedor'] ?>" class="btn btn-warning btn-xs"><i class="fas fa-edit"></i></a>
                                                    <!-- <button type="button" onclick="confirmaExclusao('<php echo $data['id_receita'] ?>')" class="btn btn-danger btn-xs">Excluir</button> -->
                                                    <button type="button" onclick="document.getElementById('id_fornecedor').value = '<?php echo  $data['id_fornecedor'] ?>'" data-toggle="modal" data-target="#modal-default" class="btn btn-danger btn-xs"><i class="fas fa-trash"></i></button>
                                                </td>
                                            </tr>
                                        <?php endforeach ?>
                                    <?php else : ?>
                                        <tr>
                                            <td colspan="7">Nenhuma fornecedor cadastrada</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
