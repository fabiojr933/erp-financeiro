            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <a class="btn btn-primary btn-group" style="margin-right: 15px;" href="/dre/analitico"><i class="fas fa-share"></i></a>
                        <li class="breadcrumb-item"><a href="/inicio">Inicio</a></li>
                        <li class="breadcrumb-item"><a href="/dre/analitico">dre</a></li>
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card no-print">
                <div class="card-body">
                    <form action="/dre/analitico" method="get">
                        <div class="row">
                            <div class="col-lg-4">
                ...
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">DRE ANALITICO</h3>
                        </div>
                        <div class="col-lg-12">
                            <div class="card">
                                <!-- /.card-header -->
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($contaDre as $dataContaDre) { ?>
                                                <tr>
                                                    ...
                                                    <?php foreach ($contaFluxo as $dataFluxo) { ?>
                                                        <?php if ($dataContaDre['id_contaDre'] == $dataFluxo['id_contaDre']) : ?>
                                                <tr>
                                                    <td style="padding-left: 100px">(-) <?php echo $dataFluxo['nome'] ?></td>
                                                    <?php foreach ($valoresContaFluxo as $dataFluxoValor) { ?>
