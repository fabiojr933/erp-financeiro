    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card no-print">
                <div class="card-body">
                    <form action="/grafico/receita" method="get">
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <div class="card card-primary card-tabs">
                                    <div class="card-header p-0 pt-1">
                                        <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="custom-tabs-two-home-tab" data-toggle="pill" href="#custom-tabs-two-home" role="tab" aria-controls="custom-tabs-two-home" aria-selected="true">Relatorios de receitas</a>
                                            </li>                                           
                                        </ul>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <div class="tab-pane fade show active" id="custom-tabs-two-home" role="tabpanel" aria-labelledby="custom-tabs-two-home-tab">
                                                <div class="card-body table-responsive p-0">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div>
                                                                <div id="ReceitaPieChart" style="width: 800px; height: 400px"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div>
                                                            <div id="ReceitaPieChart2" style="width: 600px; height: 350px"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
$dataReceita = [['Nome', 'Total']];
foreach ($valoresReceita as $value) {
    $dataReceita[] = [$value['nome'], floatval(number_format($value['total'], 2, ',', '.'))];
}
$dados_json = json_encode($dataReceita);
?>
...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        var chart = new google.visualization.PieChart(document.getElementById('ReceitaPieChart'));
...
<script type="text/javascript">
      ...
      function drawStuff() {
        ...
        var chart = new google.charts.Bar(document.getElementById('ReceitaPieChart2'));
